...
\begin{figure}[htb!]
  \includegraphics[width=\textwidth]{model_pressure.png}
  \caption{Pressure field from Darcy's Law with associated airflow streamlines.}
  \label{fig:model_pressure}
\end{figure}

\begin{figure}[htb!]
  \includegraphics[width=\textwidth]{model_concentration.png}
...
\begin{figure}[htb!]
  \includegraphics[width=\textwidth]{model_velocity_crack.png}
...
\begin{figure}[htb!]
  \includegraphics[width=\textwidth]{model_transport_flux_y.png}
...
\begin{figure}[htb!]
  \includegraphics[width=\textwidth]{model_cell_peclet.png}
