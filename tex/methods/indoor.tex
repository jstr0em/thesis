...
Solving \eqref{eq:cstr} requires us to determine the contaminant entry and air exchange rate.
...
\end{equation}
here $D_\mathrm{air} = \SI{7.2e-6}{\metre\squared\per\second}$ is the diffusion coefficient of TCE in air (but could be substituted for any contaminant of interest); % TODO: Make sure this is right
