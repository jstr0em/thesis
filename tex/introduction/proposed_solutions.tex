...
Most buildings are naturally pressurized due to the operation of heating, ventilation, and air conditioning systems, and the so-called stack effect, a topic that will be covered in greater detail in Chapter (TBD). % TODO: Add reference to where I discuss the stack effect
...
Within the CPM framework, overpressurizing a building will prevent contaminant entry from occurring.
